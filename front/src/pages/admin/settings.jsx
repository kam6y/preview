      ...
      <main className="p-6 bg-brand-lightGray">
        ...
        <section className="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-black text-base mt-2">配信間隔: <span className="font-semibold">3日</span></p>
          </div>
        ...
        <section className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mb-6">
            ...
            <p className="text-black text-base mt-2">配信間隔: <span className="font-semibold">1週間</span></p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-black text-base mt-2">配信間隔: <span className="font-semibold">1日</span></p>
          </div>
        </section>
