...
export default function ManagerDashboardImprovementPage() {
  ...
  const initialImprovements = [
    { 
      ...
      description: '営業部が抱えていた「資料作成の非効率性」という課題に対して、テンプレート化とマニュアル整備を実施。効果的な解決策として評価されました。',
      satisfaction: '+1.2',
      budget: '50万円',
      deadline: '2025年6月30日',
      comments: [
        { author: '田中（人事部）', date: '2025/03/15', text: 'この施策は他部署にも展開できると思います。'},
        { author: '山田（リンク社）', date: '2025/03/18', text: '弊社でも同様の取り組みを検討中です。情報共有お願いします。'}
      ]
    },
    { 
      id: 2, 
    ...
    { 
      ...
      description: 'IT部が中心となって社内のペーパーレス化と情報共有の迅速化を図るためのデジタルツールを導入。',
      satisfaction: '+1.5',
      budget: '300万円',
      deadline: '2025年9月30日',
      comments: []
    ...
    { 
      ...
      manager: '山田花子',
      issue: 'サイロ化による情報断絶',
      description: '各部門間の情報共有を円滑にするためのクロスファンクショナルな定例会議を導入。',
      satisfaction: '+0.9',
      budget: '10万円',
      deadline: '2025年6月1日',
      comments: []
    ...
    { 
      ...
      description: '社内のナレッジやノウハウを蓄積・共有できるプラットフォームを構築し、情報の属人化を解消。',
      satisfaction: '+1.3',
      budget: '150万円',
      deadline: '2025年3月31日',
      comments: [
        { author: '田中（人事部）', date: '2025/02/10', text: 'システム導入後、新人研修での活用も検討しています。'},
        { author: '高橋（IT部）', date: '2025/02/15', text: 'アクセス権限の設定について次回会議で確認したいです。'}
      ]
    },
    { 
      id: 10, 
    ...
    { 
      ...
      manager: '高橋健太',
      issue: '保守コストの増大',
      description: 'IT部が主導し、メンテナンスコストが高騰していた旧システムから新システムへの完全移行を実施。データ移行とトレーニングを通じてスムーズな移行を実現しました。',
      satisfaction: '+1.6',
      budget: '500万円',
      deadline: '2025年1月31日',
      comments: [
        { author: '鈴木（営業部）', date: '2025/01/20', text: '新システムの操作性が向上し、日々の業務効率が大幅に改善しました。'},
        { author: '高橋（IT部）', date: '2025/01/25', text: '保守コストが年間約30%削減できる見込みです。'},
        { author: '田中（経理部）', date: '2025/02/05', text: 'レポート機能が充実し、月次集計の工数が半減しました。'}
      ]
    },
    { 
      id: 14, 
  ...
  useEffect(() => {
    ...
    const generateChartData = () => {
      // 組織に応じて少し数値を変える
      const seedValue = selectedOrg === 'AAA' ? 1.0 : 
  ...
  const successCasesData = [
    {
      ...
      manager: "山田太郎",
      department: "人事部",
      description: "週2回のリモートワークを導入し、通勤時間の削減と働き方の柔軟性を向上させました。"
    },
    {
      title: "営業支援ツール導入",
      category: "効率化",
      ...
      manager: "佐藤次郎",
      department: "営業部",
      description: "CRMツールを導入し、顧客データの一元管理と営業活動の効率化を実現しました。"
    },
    {
      title: "新人研修プログラム改善",
      category: "教育",
      ...
      manager: "鈴木花子",
      department: "人事部",
      description: "実践型のカリキュラムを取り入れ、新入社員の早期スキルアップを実現しました。"
    },
    {
      title: "SNSマーケティング強化",
      category: "マーケティング",
      ...
      manager: "高橋健太",
      department: "マーケティング部",
      description: "Instagram広告とインフルエンサー施策により、Z世代への認知度が30%向上しました。"
    }
  ];
